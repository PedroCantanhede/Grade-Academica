    ...
    <div class="w-full mb-1">
      <div class="mb-4">
        ...
        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
          Lista de todas as disciplinas com suas respectivas cargas horárias e
          créditos.
        </p>
      </div>
      <div class="sm:flex">
        ...
        >
          <form class="lg:pr-3" action="#" method="GET">
            <label for="disciplinas-search" class="sr-only">Buscar</label>
            <div class="relative mt-1 lg:w-64 xl:w-96">
              <input
                type="text"
                name="search"
                id="disciplinas-search"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{
                editIndex === -1 ? "Adicionar Disciplina" : "Editar Disciplina"
              }}
            </h3>
            <button
              type="button"
...
export default {
  ...
  methods: {
    ...
    saveDisciplina() {
      if (this.editIndex === -1) {
        this.disciplinas.push({ ...this.formData });
      } else {
        Object.assign(this.disciplinas[this.editIndex], this.formData);
      }
      this.closeModal();
    },
    editDisciplina(index) {
      this.editIndex = index;
      this.formData = { ...this.disciplinas[index] };
      this.openModal();
    },
