<template>
  <div class="py-32 sm:py-48 lg:py-20 px-4 sm:px-6 lg:px-12">
    ...
    <div class="w-full mb-1">
      <div class="mb-4">
        ...
        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
          Lista de todas as salas com seus respectivos pavilhões e andares.
        </p>
      </div>
      <div class="sm:flex">
        <div
        ...
        >
          <form class="lg:pr-3" action="#" method="GET">
            <label for="salas-search" class="sr-only">Buscar</label>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{
                editIndex === -1 ? "Adicionar Sala" : "Editar Sala"
              }}
            </h3>
            <button
              type="button"
    ...
    <!-- Tabela para exibir salas existentes -->
    <div
        ...
        >
          ...
          >
            <tr>
              ...
              <th scope="col" class="px-6 py-3">Pavilhão</th>
              <th scope="col" class="px-6 py-3">Andar</th>
          ...
          <tbody>
            <!-- Loop para exibir cada sala -->
            <tr
              v-for="(sala, index) in salas"
              :key="index"
              class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
            >
              <td class="px-6 py-4">{{ sala.sala }}</td>
              <td class="px-6 py-4">{{ sala.pavilhao }}</td>
              <td class="px-6 py-4">{{ sala.andar }}</td>
              <td class="px-6 py-4 text-right">
                <button
                  @click="editSala(index)"
...
export default {
  ...
  data() {
    return {
      ...
      editIndex: -1,
      salas: [
        { sala: "316", pavilhao: 60, andar: 4 },
        { sala: "314", pavilhao: 45, andar: 3 },
        { sala: "322", pavilhao: 50, andar: 3 },
      ],
      formData: {
        sala: "",
        pavilhao: "",
  ...
  methods: {
    ...
    saveSala() {
      if (this.editIndex === -1) {
        this.salas.push({ ...this.formData });
      } else {
        Object.assign(this.salas[this.editIndex], this.formData);
      }
      this.closeModal();
    },
    editSala(index) {
      this.editIndex = index;
      this.formData = { ...this.salas[index] };
      this.openModal();
    },
    deleteSala(index) {
