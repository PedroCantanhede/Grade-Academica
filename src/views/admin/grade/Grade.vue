<template>
  <div class="py-32 sm:py-48 lg:py-20 px-4 sm:px-6 lg:px-12">
    ...
    <div class="w-full mb-1">
      <div class="mb-4">
        ...
        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
          Grade contendo ano letivo, semestre e período.
        </p>
      </div>
      <div class="sm:flex">
        <div
        ...
        >
          <form class="lg:pr-3" action="#" method="GET">
            <label for="grades-search" class="sr-only">Buscar</label>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
              {{
                editIndex === -1 ? "Adicionar Grade" : "Editar Grade"
              }}
            </h3>
            <button
              type="button"
            ...
            <form @submit.prevent="saveGrade">
              <div class="mb-4">
                <label
                  ...
                  >Ano Letivo da Grade</label
                >
                <input
                  type="text"
                  id="anoLetivo"
                  v-model="formData.anoLetivo"
    ...
    <!-- Tabela para exibir itens existentes -->
    <div
      ...
      <div class="overflow-x-auto">
        ...
        >
          ...
          <tbody>
            ...
            >
              <td class="px-6 py-4">{{ grade.anoLetivo }}</td>
              <td class="px-6 py-4">{{ grade.semestre }}</td>
              <td class="px-6 py-4">{{ grade.periodo }}</td>
              <td class="px-6 py-4 text-right">
                <button
                  @click="editGrade(index)"
...
export default {
  ...
  data() {
    return {
      ...
      editIndex: -1,
      grades: [
        { anoLetivo: "2024.1", semestre: 1, periodo: 4 },
        { anoLetivo: "2024.1", semestre: 2, periodo: 2 },
        { anoLetivo: "2024.1", semestre: 2, periodo: 3 },
      ],
      formData: {
        anoLetivo: "",
        semestre: "",
  ...
  methods: {
    ...
    saveGrade() {
      if (this.editIndex === -1) {
        this.grades.push({ ...this.formData });
      } else {
        Object.assign(this.grades[this.editIndex], this.formData);
      }
      this.closeModal();
    },
    editGrade(index) {
      this.editIndex = index;
      this.formData = { ...this.grades[index] };
      this.openModal();
    },
    deleteGrade(index) {
